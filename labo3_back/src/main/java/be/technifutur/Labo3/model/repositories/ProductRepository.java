...
public interface ProductRepository extends JpaRepository<Product, Integer>, QuerydslPredicateExecutor {
    ...
    List<Product> findAllByIsActiveAndQuantityGreaterThanOrderByProductId(boolean bool, int nb);

    List<Product> findAllByIsActiveAndQuantityGreaterThanOrderByProductId(boolean bool, int nb, Pageable var1);
